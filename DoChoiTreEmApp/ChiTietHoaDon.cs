...
namespace DoChoiTreEmApp
{
    public partial class ChiTietHoaDon : Form
    {
        ...
        {
            string StringID = frmDonHang.hdid;
            string StringMasp = frmDonHang.hdmasp;
            string StringHDtensp = frmDonHang.hdtensp;
            string StringHDsl = frmDonHang.hdsl;
            string StringHDdongia = frmDonHang.hddongia;
            string StringHDloai = frmDonHang.hdloai;
            string StringHDdonvi = frmDonHang.hddonvi;
            string StringHDthanhtoan = frmDonHang.hdthanhtoan;
            string StringHDsdt = frmDonHang.sdt;
            string StringHDtenKH = frmDonHang.tenkh;
            string StringHDtime = frmDonHang.hdtime;
            string StringHDno = frmDonHang.hdno;
            string StringHDnvtt = frmDonHang.nvtt;
