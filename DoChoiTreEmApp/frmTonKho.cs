...
namespace DoChoiTreEmApp
{
    public partial class frmTonKho : Form
    {
        ...
        {
            string querysp = @"select masp as 'Mã sản phẩm', tensp as 'Tên sản phẩm', soluongsp as 'Số lượng', gianhapsp as 'Giá nhập', giabansp as 'Giá bán', loaisp as 'Loại', donvisp as 'Thương hiệu',giamgia as 'Giảm giá' from tonkho";
            SqlDataAdapter sqldatasp = new SqlDataAdapter(querysp, connect);
            DataTable datatbsp = new DataTable();
            sqldatasp.Fill(datatbsp);
            dataGridView1.DataSource = datatbsp;
        ...
        private void comboloai_RightToLeftChanged(object sender, EventArgs e)
        {
            if (string.IsNullOrWhiteSpace(txtid.Text))
            {
                autoid();
        ...
        private void combodonvi_SelectedIndexChanged(object sender, EventArgs e)
        {
