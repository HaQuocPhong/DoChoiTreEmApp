...
{
    public partial class frmThôngTinHoaDon : Form
    {
        ...
        string sdtkh = frmBanHang.TenKH;
        string tenkh = frmBanHang.SDT;
        ...
        public frmThôngTinHoaDon(ListBox.ObjectCollection Items)
        {
            InitializeComponent();

            txtTTOK.Text = frmBanHang.thanhtoan;
            listBox2.Items.AddRange(Items);
        }

        private void frmThôngTinHoaDon_Load(object sender, EventArgs e)
        {
            try
            {
                connect.Open();
                ...
                else
                {
                    ...
                    try
                    {
                        using (var cmd = new SqlCommand("INSERT INTO HoaDon (HDmasp,HDtensp,HDsl,HDdongia,HDloai,HDthanhtoan,HDdonvi,HDno,SDT,TenKH,HDtime,nvthanhtoan) VALUES (@HDmasp,@HDtensp,@HDsl,@HDdongia,@HDloai, @HDthanhtoan,@HDdonvi,@HDno,@SDT,@TenKH,@HDtime,@nvthanhtoan)"))
                        {
                            ...
                            cmd.Parameters.AddWithValue("@HDmasp", frmBanHang.HDmasp);
                            cmd.Parameters.AddWithValue("@HDtensp", frmBanHang.HDtensp);
                            cmd.Parameters.AddWithValue("@HDsl", frmBanHang.HDsl);
                            cmd.Parameters.AddWithValue("@HDdongia", frmBanHang.HDdongia);
                            cmd.Parameters.AddWithValue("@HDloai", frmBanHang.HDloai);
                            cmd.Parameters.AddWithValue("@HDthanhtoan", TienOK);//

                            cmd.Parameters.AddWithValue("@HDdonvi", frmBanHang.HDdonvi);
                            cmd.Parameters.AddWithValue("@HDno", txtno);

                            cmd.Parameters.AddWithValue("@SDT", frmBanHang.SDT);
                            cmd.Parameters.AddWithValue("@TenKH", frmBanHang.TenKH);
                            cmd.Parameters.Add("@HDtime", SqlDbType.DateTime);
                            cmd.Parameters["@HDtime"].Value = DateTime.Now;
                            cmd.Parameters.AddWithValue("@nvthanhtoan", frmMain.tennv);
                            connect.Open();
